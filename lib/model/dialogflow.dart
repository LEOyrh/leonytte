...
class Dialogflow {
  ...
  String _getUrl() {
    //print(authGoogle.getProjectId);
    //print("sessionid: " + authGoogle.getSessionId);
  ...
  Future<AIResponse> detectIntent(query, lang) async {
    ...
    //  String body =
    //     '{"queryInput":{"text":{"text": $query,"languageCode": $lang}}';
    String body =
        '{"queryInput": { "text": { "text": "$query", "languageCode": "$lang",}}, "queryParams": $queryParams}';
    //  try {

    try {
      print("String Token: " + authGoogle.getToken);
